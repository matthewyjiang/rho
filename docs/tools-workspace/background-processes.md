...
`process` requests the Process capability. [Permission modes](/configuration/permissions)
...
- [Permission modes](/configuration/permissions) - plan, auto, allow_edits, and supervised
  process policy
