...
- Foreground waits for the run and returns its final result. Independent agent calls in the same step run together - issue them in one turn for parallel work.
