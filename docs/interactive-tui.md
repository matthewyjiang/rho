...
| `/fast [on\|off]` | Toggle or set the faster tier for supported Codex and Cursor models. Fast mode saves to configuration, appears as `(fast)` after the model name, and uses credits at a higher rate. |
