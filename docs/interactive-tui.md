...
| `/fast [on\|off\|status]` | Toggle, set, or inspect the faster priority tier for supported Codex models. Fast mode saves to configuration and uses credits at a higher rate. |
