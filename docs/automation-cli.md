...
| `rho attach [ID]` | Watch a delegated agent run in a read-only TUI. Omit the id to pick from running subagents. See [subagents](/subagents/attachment-and-artifacts). |
