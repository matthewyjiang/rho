...
5. binary assets and the Arch package **build** start after the app draft tag
   exists, beside crate publication
6. Arch package **publication** to mjiang-extras starts only after crates succeed
