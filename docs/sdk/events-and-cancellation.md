...
Retryable physical provider request failures also emit `ProviderRequestRetry` before the next attempt. Provider-native web search activity emits `WebSearch`.
