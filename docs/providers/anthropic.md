...
API-key login opens a masked key entry box. `/login anthropic-oauth` opens the browser, then asks you to paste the authorization code from the callback page (`code#state`).
