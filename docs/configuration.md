...
- `plan` allows investigation of the workspace, the user's global `AGENTS.md`, skill trees, and agent definitions, but denies file writes, process execution, and other reads outside the workspace.
