...
- `docs/assets/rho-ui-demo.svg` and `docs/public/assets/rho-ui-demo-light.svg` - terminal UI proof plates (dark README + theme-matched site light; regenerated from the PTY harness)
