...
use super::{
    ...
    CatalogLookupMode, CatalogReasoningPolicy, ModelIdCodec, OpenAiCompatibleApi,
...
pub const PROVIDERS: &[ProviderDescriptor] = &[
    ...
    ProviderDescriptor {
        ...
        auth_modes: &[AuthMode {
            id: "minimax-api-key",
            login_label: "MiniMax API key",
            auth_kind: ProviderAuthKind::ApiKey {
                env_var: "MINIMAX_API_KEY",
                account: MINIMAX_API_KEY_ACCOUNT,
                entry_label: "MiniMax API key",
                missing_message: "missing MiniMax API key; run /login minimax in the TUI or set MINIMAX_API_KEY as a CI/dev override",
            },
        }],
        model_source: ProviderModelSource::CachedProviderModels,
        model_refresh: Some(ProviderModelRefreshKind::AnthropicCompatible),
        model_id_codec: ModelIdCodec::Plain,
        metadata_upstream: "minimax",
        catalog_lookup: CatalogLookupMode::Slug,
