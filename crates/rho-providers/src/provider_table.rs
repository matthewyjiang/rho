...
use super::{
    AuthMode, BearerCredentialAcquisition, BrowserOAuthFlow, CatalogReasoningPolicy,
    FastModePolicy, ModelIdCodec, OpenAiRuntimeAuth, ProviderAuthKind, ProviderDescriptor,
    ProviderId, ProviderModelRefreshKind, ProviderModelSource, ProviderRuntime,
    ANTHROPIC_API_KEY_ACCOUNT, CODEX_TOKENS_ACCOUNT, CURSOR_TOKENS_ACCOUNT,
...
pub const PROVIDERS: &[ProviderDescriptor] = &[
    ...
    ProviderDescriptor {
        ...
        model_refresh: None,
        model_id_codec: ModelIdCodec::Plain,
        fast_mode: FastModePolicy::CodexPriority,
        metadata_upstream: "openai",
        catalog_reasoning: CatalogReasoningPolicy::ExactAdvertised,
        default_model: None,
    },
    ...
    ProviderDescriptor {
        ...
        model_id_codec: ModelIdCodec::CursorVariants,
        fast_mode: FastModePolicy::CursorSuffix,
