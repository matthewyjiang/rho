...
const TOOL_DESCRIPTION: &str = r#"Use `apply_patch` for multi-hunk or multi-file edits with a Codex-style patch. Use `write` to create or fully rewrite a file.
...
- Use `write` instead when replacing a complete file"#;
