...
impl Tool for WriteFile {
    fn spec(&self) -> ToolSpec {
        ToolSpec {
            ...
            description: "Creates or fully rewrites a UTF-8 text file with complete contents. Prefer edit_file for one exact string replacement in an existing file, and apply_patch for multi-hunk or multi-file edits.".into(),
