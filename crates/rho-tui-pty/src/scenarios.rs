...
impl ScenarioId {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::BackgroundAgentDraftPriority => "background_agent_draft_priority",
        }
    }
    ...
    pub fn parse(name: &str) -> Option<Self> {
        match name {
            ...
            "background_agent_draft_priority" => Some(Self::BackgroundAgentDraftPriority),
            _ => None,
        }
    }
}
...
pub fn all_scenarios() -> &'static [Scenario] {
    &[
        ...
        Scenario {
            ...
            size: DEFAULT_SIZE,
            steps: background_agents::AUTO_DELIVERY_STEPS,
            smoke: false,
        },
        Scenario {
            id: "background_agent_draft_priority",
            description: "Prioritize a pending user draft over background completion delivery",
            size: DEFAULT_SIZE,
            steps: background_agents::DRAFT_PRIORITY_STEPS,
            smoke: false,
        },
    ]
}
