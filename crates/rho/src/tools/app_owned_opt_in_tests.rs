...
async fn preparation_rejects_invalid_resource_keys_and_actions() {
    ...
    let get_search_content = web::sdk_get_search_content::SdkGetSearchContent::new(12_000, web::WebAccessStore::new());
...
async fn web_search_prepares_tool_managed_network() {
    ...
    let tool = web::SdkWebSearch::new(web::access_tools_with_store(&crate::config::Config::default(), web::WebAccessStore::new()), 12_000);
    let prepared = tool
        .prepare(
