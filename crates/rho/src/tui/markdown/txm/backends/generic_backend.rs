use crate::tui::markdown::txm::ast::BinOp;
use crate::tui::markdown::txm::backend::RenderTarget;
use crate::tui::markdown::txm::layout_tree::{LayoutNode, LineStyle, NodeKind};
...
mod tests {
    ...
    use crate::tui::markdown::txm::backend::RenderTarget;
    use crate::tui::markdown::txm::style::{Color, Style};
    ...
    fn current_color_reaches_generated_renderer_cells() {
        for input in [
            ...
            let tree = crate::tui::markdown::txm::layout(input).unwrap();
